-- Fix discount functions with proper cleanup
-- This will drop all existing functions and create new ones with correct types

-- 1. Drop ALL existing discount functions first
...
DROP FUNCTION IF EXISTS validate_promotion_code(TEXT, TEXT, DATE);
DROP FUNCTION IF EXISTS validate_promotion_code(TEXT, TEXT);
