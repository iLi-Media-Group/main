-- Fix roster views with exact data types that match existing views
-- This addresses the data type mismatch for year column
...
-- ============================================
-- 2. CREATE VIEWS WITH EXACT DATA TYPES
-- ============================================
...
SELECT 
    ...
    re.entity_type,
    re.rights_holder_id,
    CAST(2025 AS NUMERIC) as year,
    CAST(1 AS NUMERIC) as month,
...
SELECT 
    ...
    re.entity_type,
    re.rights_holder_id,
    CAST(2025 AS NUMERIC) as current_year,
