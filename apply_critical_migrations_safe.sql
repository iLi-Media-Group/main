-- Critical Safe Migrations for Restored Database
...
-- Storage policies for contracts-and-forms bucket (only if they don't exist)
...
-- Insert some default resources if the table is empty
