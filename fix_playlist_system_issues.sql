-- Fix Playlist System Database Issues
-- Run this in Supabase SQL Editor to resolve the 400 and 406 errors
...
-- Create proper RLS policies for playlist_tracks
...
-- Create proper RLS policies for playlist_views
...
-- Drop and recreate the generate_playlist_slug function
...
GRANT ALL ON playlist_views TO authenticated;
GRANT EXECUTE ON FUNCTION generate_playlist_slug(TEXT, UUID) TO authenticated;

-- Verify the setup
SELECT 'Tables created successfully' as status;

-- Test the function
SELECT generate_playlist_slug('Test Playlist', '00000000-0000-0000-0000-000000000000') as test_slug;
