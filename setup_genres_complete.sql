-- Complete Genre Setup Script
-- Run this in your Supabase SQL editor to create tables and insert all genres
...
SELECT 'Genres created:' as info, COUNT(*) as total_genres FROM genres;
SELECT 'Sub-genres created:' as info, COUNT(*) as total_sub_genres FROM sub_genres;
