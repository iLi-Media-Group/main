-- Fix duplicate discount functions issue
-- This will drop the old functions and create the new enhanced ones
...
-- 2. Create the enhanced get_applicable_discounts function
...
-- 3. Create the enhanced calculate_discounted_price function
