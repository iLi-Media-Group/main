          ...
          <div className="flex items-center justify-end w-1/3">
            ...
            {user && (
              <button
                ...
                className="flex items-center px-4 py-2 text-gray-300 hover:text-white transition-colors rounded focus:outline-none focus:ring-2 focus:ring-blue-400 mr-4"
              >
