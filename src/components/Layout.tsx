      ...
      {!hideHeader && (
        ...
        <nav className="container mx-auto flex justify-between items-center relative">
          ...
          <div className="flex items-center justify-end w-1/3">
            ...
            {isMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 rounded-lg bg-blue-900/90 backdrop-blur-sm border border-blue-500/20 shadow-xl z-[9999] top-full max-h-[80vh] overflow-y-auto isolate pointer-events-auto relative">
      ...
      {hideHeader && (
        <header className="fixed top-0 left-0 right-0 z-50 py-4 px-4">
          <nav className="container mx-auto flex justify-between items-center">
            ...
            {/* Menu Dropdown */}
            {isMenuOpen && (
              <div className="absolute right-4 mt-2 w-48 rounded-lg bg-blue-900/90 backdrop-blur-sm border border-blue-500/20 shadow-xl z-[9999] top-full max-h-[80vh] overflow-y-auto isolate pointer-events-auto relative">
                <div className="py-1 relative overflow-hidden">
                  {/* Common menu items for all users */}
                  <Link to="/catalog" className="flex items-center px-4 py-2 text-gray-300 hover:text-white hover:bg-blue-800/50" onClick={() => setIsMenuOpen(false)}>
                    <Library className="w-4 h-4 mr-2" />Browse Catalog
