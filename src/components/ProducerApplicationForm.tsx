...
import { CheckCircle, User, Mail, Music, Briefcase, Info, ArrowRight, Loader2 } from 'lucide-react';
    ...
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white/10 backdrop-blur-md p-8 rounded-xl shadow-lg space-y-8 mt-8">
      ...
      {step === 0 && (
        <div className="space-y-4 animate-fade-in">
          ...
          <input name="email" placeholder="Email" value={formData.email} onChange={handleChange} required className="w-full border p-3 rounded text-black" />
        </div>
      )}
      {step === 1 && (
        <div className="space-y-4 animate-fade-in">
