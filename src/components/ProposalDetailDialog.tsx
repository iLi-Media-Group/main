...
export function ProposalDetailDialog({
  ...
  // Show negotiation acceptance dialog if needed
  const needsNegotiationAcceptance = proposal && proposal.negotiation_status === 'client_acceptance_required' && (proposal.negotiated_amount || proposal.negotiated_payment_terms);
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-blue-900 p-6 rounded-xl border border-purple-500/20 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {loading ? (
            ...
            <div className="space-y-6">
              <div className="bg-white/5 rounded-lg p-6">
                ...
                {canAccept && !needsNegotiationAcceptance && (
