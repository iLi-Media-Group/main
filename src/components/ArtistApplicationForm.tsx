          ...
          <div className="space-y-6">
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-4">
                Before taking the quiz, please watch this brief course on sync licensing fundamentals:
              </p>
              <div className="bg-black/20 rounded-lg p-4 mb-4">
                <p className="text-gray-300 text-sm">
                  <strong>Course Content:</strong><br/>
                  • Understanding sync licensing<br/>
                  • Master vs. publishing rights<br/>
                  • One-stop licensing<br/>
                  • Common licensing scenarios<br/>
                  • Rights and permissions
                </p>
              </div>
              <p className="text-gray-300 text-sm">
                <strong>Note:</strong> This course is designed to help you understand the basics of sync licensing. 
                The quiz that follows will test your knowledge of these concepts.
              </p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">
                Have you completed the sync licensing course?
              </label>
              <select
