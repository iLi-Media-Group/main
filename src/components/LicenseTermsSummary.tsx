    ...
    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-blue-500/20 p-6">
      <div className="flex items-start space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-300">Please review these terms before proceeding with your {licenseType} license purchase.</p>
        </div>
      </div>
      {error && (
      ...
      <div className="space-y-6 mb-6">
        <div>
          <h4 className="text-white font-semibold mb-1">1. GRANT OF LICENSE</h4>
        ...
        <div>
          <h4 className="text-white font-semibold mb-1">2. TERM OF LICENSE</h4>
          <p className="text-gray-300">The license starts on the purchase date and expires after {licenseDuration}.</p>
        </div>
        <div>
          <h4 className="text-white font-semibold mb-1">3. PERMITTED USES</h4>
          <div className="text-gray-300">{permittedUse}</div>
        </div>
        <div>
          <h4 className="text-white font-semibold mb-1">4. SCOPE OF USE</h4>
        ...
        <div>
          <h4 className="text-white font-semibold mb-1">5. MODIFICATIONS</h4>
        ...
        <div>
          <h4 className="text-white font-semibold mb-1">6. RESTRICTIONS</h4>
        ...
        <div>
          <h4 className="text-white font-semibold mb-1">7. COMPENSATION</h4>
        ...
        <div>
          <h4 className="text-white font-semibold mb-1">8. CREDIT</h4>
          <p className="text-gray-300">Licensee is required to credit the Music creator in their production.</p>
        </div>
        <div>
          <h4 className="text-white font-semibold mb-1">9. TERMINATION</h4>
        ...
        <div>
          <h4 className="text-white font-semibold mb-1">10. GOVERNING LAW</h4>
      ...
      <div className="bg-blue-900/20 border border-blue-500/20 rounded-lg p-4">
        <p className="text-sm text-gray-300">By proceeding with your purchase, you acknowledge and accept these terms. A complete license agreement will be provided after checkout.</p>
      </div>
      <button
