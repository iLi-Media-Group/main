...
-- Run this in Supabase SQL Editor to create the playlist functionality
...
UNION ALL
SELECT 'Playlist Tracks' as table_name, COUNT(*) as count FROM playlist_tracks
UNION ALL
SELECT 'Playlist Views' as table_name, COUNT(*) as count FROM playlist_views;
