-- First, let's check the structure of the stripe_customers table
SELECT column_name, data_type, is_nullable 
FROM information_schema.columns 
WHERE table_name = 'stripe_customers' 
ORDER BY ordinal_position;

-- Create missing Stripe customer with correct columns
-- Based on typical Stripe customer table structure
