-- Fix the handle_negotiation_acceptance function to resolve ambiguous column references
-- The issue is that payment_terms and other columns need to be properly qualified
