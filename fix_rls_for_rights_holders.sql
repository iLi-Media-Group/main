-- Fix RLS policies to allow rights holders to see open custom sync requests
-- The issue is that rights holders need to see open requests regardless of selected_rights_holder_id
