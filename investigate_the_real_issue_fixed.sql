-- Investigate the real issue preventing view creation (FIXED)
...
WHERE table_name LIKE '%roster%' OR table_name LIKE '%analytics%';
...
-- ============================================
-- 8. CHECK ALL EXISTING VIEWS
-- ============================================

SELECT 'All existing views' as check_item, 
       (SELECT COUNT(*) FROM information_schema.views) as total_views;

SELECT table_name as existing_view_name
FROM information_schema.views
ORDER BY table_name;
