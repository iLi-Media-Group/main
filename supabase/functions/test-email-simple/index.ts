...
serve(async (req) => {
  ...
  console.log('Test email function headers:', Object.fromEntries(req.headers.entries()))

  // Handle preflight requests
  if (req.method === 'OPTIONS') {
    console.log('Handling OPTIONS preflight request for test email function')
  ...
  try {
    ...
    console.log('Test email function received data:', { to, subject, hasHtml: !!html, hasText: !!text })
    ...
    return new Response(
      JSON.stringify({ 
        success: true, 
        message: 'Test email logged successfully (no actual email sent)',
        to: to,
        subject: subject
      }),
      { 
