...
-- Create trackouts bucket if it doesn't exist
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES ('trackouts', 'trackouts', false, 52428800, ARRAY['audio/mpeg', 'audio/mp3', 'audio/wav', 'application/zip'])
ON CONFLICT (id) DO NOTHING;

-- Create stems bucket if it doesn't exist
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES ('stems', 'stems', false, 52428800, ARRAY['audio/mpeg', 'audio/mp3', 'audio/wav', 'application/zip'])
ON CONFLICT (id) DO NOTHING;
