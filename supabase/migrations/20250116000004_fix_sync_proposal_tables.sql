-- Migration: Fix missing sync proposal tables and ensure proper structure
-- This fixes issues with missing proposal_negotiations and proposal_files tables

-- 1. Create proposal_negotiations table if it doesn't exist
...
-- 2. Create proposal_files table if it doesn't exist
...
-- 3. Create proposal_history table if it doesn't exist
...
-- 5. Create RLS policies for proposal_negotiations
...
-- 6. Create RLS policies for proposal_files
...
-- 7. Create RLS policies for proposal_history
...
-- 9. Ensure sync_proposals has all required columns
...
-- 10. Update status constraints to allow all valid statuses
...
-- 11. Add constraints for client_status and producer_status
...
-- 12. Add constraint for payment_status
...
-- 13. Add constraint for negotiation_status
...
-- 14. Create trigger function to update last message info
...
-- 15. Create trigger to automatically update last message info
...
-- 16. Create trigger function to track proposal history
...
-- 17. Create trigger to track status changes
