-- Fix the handle_negotiation_acceptance function to use correct negotiation_status values
-- The function was trying to set values that aren't allowed by the constraint
