-- Basic roster analytics views
-- This script creates simple views that work without complex dependencies

-- ============================================
-- 1. CREATE BASIC VIEWS
-- ============================================

-- Basic monthly revenue view per roster entity
...
-- Basic year-to-date summary view per roster entity
